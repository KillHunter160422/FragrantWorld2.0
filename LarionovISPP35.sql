...
/****** Object:  Database [FragrantWorld]    Script Date: 20.12.2024 7:50:23 ******/
CREATE DATABASE [FragrantWorld]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'FragrantWorld', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER1\MSSQL\DATA\FragrantWorld.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'FragrantWorld_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.MSSQLSERVER1\MSSQL\DATA\FragrantWorld_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [FragrantWorld] SET  ENABLE_BROKER 
GO
